...
<?php if (!is_admin()) : ?>
    ...
    <div class="flex items-center flex-shrink-0 text-gray-700 m-4 mb-6 p-2">
        ...
        <span class="font-semibold text-xl tracking-tight"><?php _e('Awesome Motive - Yaseen Taha', YTAHA_VUEJS_DEV_CHALLENGE_TEXT_DOMAIN) ?></span>
    </div>
    ...
    <div class="p-4 max-w mt-6 bg-white shadow-md rounded-md w-11/12">
        <article class="prose lg:prose-xl w-full">
            <div class="flex items-center text-center">
                ...
                <h2 class="mx-2"><?php _e('Access to the plugin is not allowed', YTAHA_VUEJS_DEV_CHALLENGE_TEXT_DOMAIN); ?></h2>
            </div>
            <p class="text-sm">
                <?php _e('This plugin is designed for users with administrator privileges. If you lack the necessary access, please reach out to the site owner for support with any plugin-related accessibility issues.', YTAHA_VUEJS_DEV_CHALLENGE_TEXT_DOMAIN); ?>
            </p>
        </article>
    </div>
    ...
    <noscript>
        ...
        <div class="p-4 max-w mt-6 bg-white shadow-md rounded-md w-11/12">
            ...
            <div class="flex items-center text-center">
                ...
                <p class="text-sm">
                    <?php _e('JavaScript is required to use this plugin. Please enable JavaScript in your browser settings.', YTAHA_VUEJS_DEV_CHALLENGE_TEXT_DOMAIN); ?>
                </p>
